...
<div align="center">
    <table border="1" id="example" class="table table-striped table-bordered">
        ...
        <tbody>
        <c:forEach var="muonSachs" items="${sachList}">
            <tr>
                <td><c:out value="${muonSachs.ma}"/></td>
                <td><c:out value="${sachs.ten}"/></td>
                <td><c:out value="${muonSachs.tacGia}"/></td>
                <td><c:out value="${hocsinhs.ten}"/></td>
                <td><c:out value="${hocsinhs.lop}"/></td>
                <td><c:out value="${muonSachs.ngayMuon}"/></td>
                <td><c:out value="${muonSachs.ngayTra}"/></td>
                <td>
