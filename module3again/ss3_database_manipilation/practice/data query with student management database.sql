...
select student.student_id,student.student_name,mark.mark,`subject`.subject_name
from mark mark join student student on mark.student_id= student.student_id join `subject` `subject` on  mark.subject_id=`subject`.subject_id
