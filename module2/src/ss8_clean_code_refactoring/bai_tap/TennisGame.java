...
public class TennisGame {
    ...
    public static String getScore(String player1Name, String player2Name, int player1Score, int player2Score) {
        ...
        if (player1Score == player2Score) {
           ...
           checkPlayer1ScoreAndPlayer2ScoreGreaterThanOrEqualTo4 (player1Score, player2Score);
        } else {
            checkPlayer1ScoreAndPlayer2ScoreLessThan3(player1Score, player2Score);
        }
        return scoreResult;
    }
    ...
    public static void checkPlayer1ScoreAndPlayer2ScoreGreaterThanOrEqualTo4(int player1Score, int player2Score) {
        String scoreResult = " ";
    ...
    public static void checkPlayer1ScoreAndPlayer2ScoreLessThan3(int player1Score, int player2Score) {
        String scoreResult = " ";
        int tempScore = 0;
        for (int i = 1; i < 3; i++) {
